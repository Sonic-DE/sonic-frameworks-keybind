...
public:
...
#if KGLOBALACCEL_ENABLE_DEPRECATED_SINCE(5, 101)
    /**
     ...
     *
     * @since 4.2
     * @deprecated since 5.101. Shortcut contexts are deprecated. No known users.
     */
    KGLOBALACCEL_DEPRECATED_VERSION(5, 101, "Shortcut contexts are deprecated.")
