...
public:
...
#if KGLOBALACCEL_ENABLE_DEPRECATED_SINCE(5, 98)
    /**
     ...
     *
     * @since 4.2
     * @deprecated since 5.98. Shortcut contexts are deprecated. No known users.
     */
    KGLOBALACCEL_DEPRECATED_VERSION(5, 98, "Shortcut contexts are deprecated.")
